...
![overview](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/overview.gif)
...
2.	Create a new Notebook
  ...
  a.	Click on ‘Start a Notebook”
    ...
    ![start notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/dsxIntro.gif)
...
1. On next screen, click on ‘New Notebook’ to create a notebook.
  ...
  ![new notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/newNotebook.gif)
2. Type ‘IA_Lab_Notebook’ as Notebook name, click on ‘from URL’ link and specify:
 https://github.com/ibmdataworks/sigmo-demos/tree/master/data-scientist/interactive-analytics/DSX_IA_Lab.ipynb
  ...
  ![start notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/createNotebook.gif)

  a.	 Select ‘Trust this Notebook to run with your Privileges’ and click on ‘Create Notebook’

  ![trust notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/sparkService.gif)
...
1.	Open your Notebook and add the data source
  ...
  ![Navigation for notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/dragDrop.gif)

  c.	Click on Connections, select the connection named ‘dashDB’

  d.	Click ‘Add Data Source’

    ![add source](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/addDataSource.gif)
1.	From the Notebook, connect to the sample sales database in dashDB
  ...
  b.	Click on ‘Insert Code’  to insert credentials for the data source ‘dashDB’
    ...
    ![insert to code](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/addSource.gif)

  c.	Rename the inserted array variable ‘credentials_1’  to ‘credentials’

    ![credentials](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/credentials.gif)

  d.	To execute code in any notebook cell, place cursor in cell and click the arrow icon in toolbar

  ![execute in notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/notebookNav.gif)
...
3.	Query, join and group data using SparkSQL Data frame API to build aggregated sales for the product line ‘Outdoor Protection’.
  ...
  ![execute in notebook](https://github.com/ibmdataworks/sigmo-demos/raw/master/data-scientist/interactive-analytics/media/finalViz.gif)
